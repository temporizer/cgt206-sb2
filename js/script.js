$(document).ready(function() {
	...
	var david = ["Beauty in this shows Wisdom comes in many forms. Even though you have the power of knowledge at your fingertips, it’s okay to do it the old fashion way.", 'The way the Dragon represents freedom as it soars above everything else and the partnership with the woman on it’s back is pure Beauty.', 'The innocence of young woman it’s not always what that woman truly is. The way that the nails and eyes look, showing “Don’t mess with me”, shows the Beauty of a strong willed woman.'];
	var jino = ["It is a beautiful thing that humans can set themselves out for whatever venture they deem necessary, and accomplish their task.", 'My children. They are the most beautiful thing in the world. When they smile, I see the innocent beauty within them.', 'There exists different types of beauty in the world. When one can sit on top of the world, and say \'I did that\', that is truly beautiful'];
	...
	$('.jimg1').hover(function() {
		$('#jinoText').html(jino[0])
	}, function() {
		$('#jinoText').html(text);
	});

	$('.jimg2').hover(function() {
		$('#jinoText').html(jino[1])
	}, function() {
		$('#jinoText').html(text);
	});

	$('.jimg3').hover(function() {
		$('#jinoText').html(jino[2])
	}, function() {
		$('#jinoText').html(text);
	});
